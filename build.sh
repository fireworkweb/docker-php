...
docker build -t fireworkweb/php:7.1-wkhtmltopdf 7.1-wkhtmltopdf
docker build -t fireworkweb/php:7.1-wkhtmltopdf-prod 7.1-wkhtmltopdf-prod
docker build --pull -t fireworkweb/php:7.2 7.2
docker build --pull -t fireworkweb/php:7.2-prod 7.2-prod
docker build -t fireworkweb/php:7.2-wkhtmltopdf 7.2-wkhtmltopdf
docker build -t fireworkweb/php:7.2-wkhtmltopdf-prod 7.2-wkhtmltopdf-prod
docker build --pull -t fireworkweb/php:7.3 7.3
docker build --pull -t fireworkweb/php:7.3-prod 7.3-prod
docker build -t fireworkweb/php:7.3-wkhtmltopdf 7.3-wkhtmltopdf
